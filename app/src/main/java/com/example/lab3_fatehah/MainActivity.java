package com.example.lab3_fatehah;
...
import com.example.lab3_fatehah.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    DataHelper dbcenter;
    //to access class CreateBio, UpdateBio, abd ViewBio
                            ...
                            public void onClick(DialogInterface dialog, int item) {
                                switch (item) {
                                    ...
                                    case 2:
                                        ...
                                        ((SQLiteDatabase) db).execSQL("delete from biodata where name = '" + selection + "'");
